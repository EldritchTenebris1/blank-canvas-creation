...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Posto Buriti — Gestão de Estoque" },
      { name: "description", content: "Sistema ERP de gestão de estoque, pista e vendas do Posto Buriti." },
      { name: "author", content: "Posto Buriti" },
      { property: "og:title", content: "Posto Buriti — Gestão de Estoque" },
